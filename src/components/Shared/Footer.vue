<template>
    <body>
            ...
            <div class="grupo-1">
                ...
                <div class="container-fluid text-center text-light mt-3">
                    ...
                    <div class="red-social">
                        ...
                        <a href="">
                            <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" fill="currentColor"
                                class="bi bi-instagram text-light mx-3" viewBox="0 0 16 16">
                                <path
        ...
        <div class="container-fluid text-center bg-primary text-light py-3">
...
.pie-pagina .grupo-1 red-social d {
